...
import com.example.yummyfood_justtasteit.adapter.RestaurantMenuAdapter
...
class RestaurantMenuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activity_restaurant_menu_Progressdialog=findViewById(R.id.restaurantMenuProgressDialog)
    ...
    fun fetchData(){
        ...
        if (ConnectionManager().checkConnectivity(this)) {
            ...
            try {
                ...
                val url = "http://13.235.250.119/v2/restaurants/fetch_result/<restaurant_id>" + restaurantId
